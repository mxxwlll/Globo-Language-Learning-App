...
import 'package:globotest/screens/chats.dart';
import 'package:globotest/screens/navigationhub.dart';

void main() {
  runApp(const ConvoChatBotScreen());
}

class ConvoChatBotScreen extends StatelessWidget {
  const ConvoChatBotScreen({super.key});
...
class ConversationChatbotForDev extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Column(
      children: [
